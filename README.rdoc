...
Either include the library directly by downloading it {here from github}[https://github.com/downloads/cschoell/Junit-DynamicSuite/junit-dynamicsuite-0.2.2.jar]
